...
const HARD_PII_PHRASES: string[] = [
  ...
  "licence number",
  "voter id",
  // Demographics / special category (GDPR Art. 9)
  "sex",
  "gender",
  "race",
  "ethnicity",
  ...
  "cvv",
  "cvc",
  // Media that can identify a person
  "photo",
  "avatar",
  "profile picture",
  "selfie",
  "signature",
  // Credentials / secrets (leaking these is at least as harmful as PII)
  "password",
  "passwd",
  "password hash",
  "secret",

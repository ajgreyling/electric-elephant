...
![mcp-vs-postgres](https://raw.githubusercontent.com/ajgreyling/electric-elephant/main/docs/images/blog/state-of-postgres-mcp-servers-2025/mcp-vs-postgres.webp)
...
- *Vendor neutral*: Electric Elephant
...
| [Electric Elephant](https://github.com/ajgreyling/electric-elephant) | 1.8k | MIT | TypeScript | 5k |
...
I maintain Electric Elephant and have tested various use cases. The one that actually works well: local development.
...
⏺ electric-elephant - Search Database Objects (postgres) (MCP)(object_type: "table", pattern: "%", detail_level: "summary")
  ⎿  {
       "success": true,
       "data": {
...
This is a Claude Code session with Electric Elephant. I'm adding org/project models to a SaaS app. After generating the Drizzle migration, Claude automatically calls Electric Elephant to verify the schema was created correctly. That feedback loop—generate, apply, verify—is what MCP enables.
...
3. [Electric Elephant](/blog/postgres-mcp-server-review-badger-db-mcp) - Zero-dependency, token efficient MCP server for PostgreSQL, MySQL, SQL Server, MariaDB, and SQLite

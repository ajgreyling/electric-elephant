...
<Tabs>
  <Tab title="npx">
    ...
    npx electric-elephant --transport http --port 8080 --demo
    ```
  </Tab>
  ...
  <Tab title="Global Installation">
    ...
    # Or use demo mode for testing
    electric-elephant --transport http --port 8080 --demo
    ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="CLI">
    ...
    # Or use demo mode for testing
    codex mcp add electric-elephant -- npx electric-elephant --transport stdio --demo
    ```
  </Tab>
  ...
  <Tab title="TOML">
    ...
    [mcp_servers.electric-elephant]
    command = "npx"
    args = ["electric-elephant", "--transport", "stdio", "--demo"]
    ```
  </Tab>
  ...
  <Tab title="Verification">
    ...
    🔌  MCP Tools
      ...
      • electric-elephant
        • Status: enabled
        • Auth: Unsupported
        • Command: npx -y electric-elephant --demo
        • Tools: execute_sql
